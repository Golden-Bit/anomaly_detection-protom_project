...
if __name__ == "__main__" and False:
    ...
    for category in mvtec_categories:
        ...
        test_result = padim_train_and_test(
...
if __name__ == "__main__" and False:
    ...
    #   If the datasets is not downloaded, it will be downloaded
    #   to this directory.
    dataset_root = Path.cwd() / "custom_datasets" / "hazelnut_toy"
    ...
    for anomaly_type in anomaly_types:
        ...
        datamodule = Folder(
            ...
            root=dataset_root,
            normal_dir="good",
            abnormal_dir=anomaly_type,
            task=task,
            mask_dir=dataset_root / "mask" / anomaly_type,
...
if __name__ == "__main__" and False:
    ...
    #   If the datasets is not downloaded, it will be downloaded
    #   to this directory.
    dataset_root = Path.cwd() / "custom_datasets" / "cabinet_surface_metallic-white" / "dataset"
    ...
    task = TaskType.SEGMENTATION
    anomaly_types = ["abnormal_white"]

    for anomaly_type in anomaly_types:

        datamodule = Folder(
            name="cabinet_surface_metallic-white",
            root=dataset_root,
            normal_dir="normal_white_tiles_256-256_8-8",
            abnormal_dir=anomaly_type,
            task=task,
            mask_dir=dataset_root / "ground_truth" / anomaly_type,
            image_size=None, #(256, 256),
            test_split_mode=TestSplitMode.FROM_DIR,
            #test_split_mode=TestSplitMode.SYNTHETIC,
            val_split_mode=ValSplitMode.SYNTHETIC,
