...
# Let's check the shapes of the input images and mask.

print(data["image"].shape, data["mask"].shape)


# We could now visualize a normal_white and abnormal_white sample from the validation set.
...
# For example, predictions for a segmentation model could contain image, anomaly maps, predicted scores, labels or mask.
