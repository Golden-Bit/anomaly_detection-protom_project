...
In addition to the root folder of the dataset, we now also specify which folder contains the normal images, which folder 
contains the anomalous images, and which folder contains the ground truth masks for the anomalous images.
"""
...
This is mainly because training only requires normal images and no labels. Now let's try test split 
